                ...
                <form className="card-text" onSubmit={onSubmit}>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            id="value1"
                            aria-describedby="value1Help"
                            placeholder="Enter first number"
                            value={a}
                            onChange={(e) => setA(parseInt(e.target.value))}
                        />
                        <small id="value1Help" className="form-text text-muted">
                            Type your first number you want to add
                        </small>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-control"
                            id="value2"
                            aria-describedby="value2Help"
                            placeholder="Enter first number"
                            value={b}
                            onChange={(e) => setB(parseInt(e.target.value))}
                        />
                        <small id="value2Help" className="form-text text-muted">
                            Type your second number you want to add
                        </small>
                    </div>
